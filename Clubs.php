...
$joinedclubsresults = $connection->query($joinedclubsQuery);
$joinedclubs = array();
...
<div class="col-lg-3 col-md-3 col-sm-4 col-xs-4">
 ...
 ?>
  ...
  <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zm-3.97-3.03a.75.75 0 0 0-1.08.022L7.477 9.417 5.384 7.323a.75.75 0 0 0-1.06 1.06L6.97 11.03a.75.75 0 0 0 1.079-.02l3.992-4.99a.75.75 0 0 0-.01-1.05z"/>
   ...
   <form class="needs-validation " method="POST" action="club_join.php" novalidate  id="form">
...
<!-- Print all The joined clubs of Current users -->
<?php
...
<div class="container">
<div class="row content" >
<div class="clubdivs allclubs col-lg-6 col-md-6 col-sm-10 col-xs-6 bg-success"  style="display:flex; align-items:center; justify-content:center; margin-left: 5% ">

    <!-- User redirect to specific Club page when Click on The Club name/ Will send name of Club -->
       <a href="SingleClub.php?clubname=<?php echo $row["clubname"] ?>" name="clubname" style="text-align: center;color: whitesmoke"><?php echo $row["clubname"] ?></a>

</div>

    <!-- This DIV includes Un-join buttons -->
<div class="col-lg-4 col-md-3 col-sm-4 col-xs-4">
        ...
        if (in_array($row["clubname"], $joinedclubs)) {
            ...
            <!--Un-join button, with hidden feature. -->
            <form class="needs-validation " method="POST" action="club_Un-join.php" novalidate  id="form">

                <input type="text" hidden name="loggedinuser" value='<?php echo $_SESSION['loggedinuser'] ?>'>

                <input type="text" hidden name="clubname" value='<?php echo $row["clubname"] ?>'>

                <button class="btn btn-danger submitbutton" type="submit " name="submit" id="sub">Un-join!</button>
            </form>
            <?php
        }
        ?>
