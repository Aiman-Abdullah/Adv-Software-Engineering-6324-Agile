...
// The Next 3 lines are for upload images to DB
...
if ($filename ==''){ 
    $sql = "UPDATE users SET firstname = '$firstname',lastname = '$lastname', email='$email',
                 city= '$city', states = '$states', zipcode = '$zipcode', facebook = '$facebook',twitter = '$twitter', linkedin = '$linkedin'  WHERE email = '$email'";
}
else{
    $sql = "UPDATE users SET firstname = '$firstname',lastname = '$lastname', email='$email', city= '$city', states = '$states', zipcode = '$zipcode', image= '$filepath', facebook = '$facebook',twitter = '$twitter', linkedin = '$linkedin' WHERE email = '$email'";
}
