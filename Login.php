<?php
/*
  * NOTE if You Get Warning says (The server requested authentication method unknown to the client [caching_sha2_password])
  * Solve the issue by do SQL command on DB side => ALTER USER 'root'@'localhost' IDENTIFIED WITH mysql_native_password BY 'root';
  */
ob_start();
include "./config.php";
